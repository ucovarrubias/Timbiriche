...
public class MenuInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(255, 175, 77));
        ...
        nombreJugador.setFont(new java.awt.Font("Montserrat", 1, 12)); // NOI18N
        ...
        btnUnirse.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        btnUnirse.setText("Unirse a la partida");
        btnUnirse.setToolTipText("Únete a la partida del servidor local");
        btnUnirse.setMaximumSize(new java.awt.Dimension(180, 180));
        btnUnirse.setMinimumSize(new java.awt.Dimension(180, 180));
        btnUnirse.setPreferredSize(new java.awt.Dimension(180, 180));
        ...
        configurarTablero.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        ...
        cerrarTimbiriche.setFont(new java.awt.Font("Montserrat", 1, 12)); // NOI18N
        ...
        btnCrearSala.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        btnCrearSala.setText("Crear nuevo juego");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(btnUnirse, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(configurarTablero, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addGap(40, 40, 40))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnCrearSala, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btnCrearSalaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearSalaActionPerformed
        SckServer scS = new SckServer();
        scS.execute();
        
        SalaEspera se = SalaEspera.getInstance();
        if(se.ejecutarConexion(jugador, "localhost", 1234)){
            se.setVisible(true);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(this,"No se pudo realizar la conexión con el servidor", "Fallo de Conexión", JOptionPane.ERROR_MESSAGE);
